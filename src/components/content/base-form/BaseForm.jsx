...
const BaseForm = ({ className, image, name, title, content, children }) => {
  return (
    ...
    >
      <div className="w-full sm:w-[45%] h-full rounded-xl overflow-hidden shadow-xl mb-5 sm:mb-0">
        <img
          src={image}
          alt=""
      ...
      <div className="flex flex-col flex-1 ">
        <div className="flex items-center self-center justify-center sm:self-start gap-x-2">
        ...
        <h2 className="text-4xl font-bold uppercase text-primary-text lg:pr-[80px] mt-9 leading-normal text-center sm:text-left">
